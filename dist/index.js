...
exports.default = function (FormInput) {
	...
	var WithValidation = function (_React$Component) {
		...
		_createClass(WithValidation, [{
			...
			value: function updateErrorMessages(newVal) {
				var value = typeof newVal !== 'undefined' ? newVal : this.state.value;
				var errMsgs = _validate(this.props.validator, value);
	...
	WithValidation.propTypes = {
		validator: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.array]),
